...
- [ ] 4. 高負荷時の安定性 — ヒューマンレビュー
- [ ] 4.1 高負荷環境でのティック動作のヒューマンレビュー
  - [ ] 4.1 Human review: ベルト500本+アイテム2000個の状態でゲームを60秒間実行し、体感的なカクつきの有無を目視確認する。目立つカクつきが発生しないこと。フレームスパイク発生時のリカバリが1秒以内であること
  - _Requirements: 8.1, 8.2_

- [ ] 4.2 一時停止・再開の応答性のヒューマンレビュー
  - [ ] 4.2 Human review: 一時停止/再開を連続10回操作し、各操作の応答性を確認する。操作から反映まで体感的な遅延がないこと
